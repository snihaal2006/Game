...
const Chapter3: React.FC = () => {
  ...
  useEffect(() => {
    if (chapter3.isDecrypted) return;
  ...
  // Chapter completion
  useEffect(() => {
    if (chapter3.solvedQuestions.length === 3 && !chapter3.evidenceCollected.includes('O')) {
      setTimeout(() => setShowCompletion(true), 1000);
    }
  }, [chapter3.solvedQuestions, chapter3.evidenceCollected]);
  ...
  const handleDecodeSubmit = () => {
    ...
    if (decodeAnswer.trim().toUpperCase() === 'PHANTOM') {
  ...
  return (
    <div style={{
      ...
      {chapter3.isDecrypted && (
        ...
        >
          <div style={{ ...orbitron, fontSize: 12, color: '#00ff66', fontWeight: 'bold', letterSpacing: 2 }}>
            [ 1 SUSPICIOUS EMAIL ]
          </div>
        </div>
      )}
      ...
      {isEmailOpen && (
        <div style={{
          ...
          <div style={{
            maxWidth: 600, width: '100%',
            background: 'rgba(20,10,0,0.95)', border: '1px solid #00ff66',
            padding: 32, position: 'relative'
          }}>
            <button 
              onClick={() => setIsEmailOpen(false)}
              style={{ position: 'absolute', top: 16, right: 16, background: 'none', border: 'none', color: '#00ff66', fontSize: 24, cursor: 'pointer' }}
            >×</button>
            <div style={{ ...orbitron, fontSize: 20, color: '#00ff66', marginBottom: 24 }}>SUSPICIOUS EMAIL</div>
            <pre style={{ ...mono, fontSize: 14, color: '#00ff66', whiteSpace: 'pre-wrap', lineHeight: 1.6 }}>
{`From: admin@skcet.ac.in
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{
              ...
              color: (!chapter3.isDecrypted && gatewayTimer <= 3) ? '#ff0000' : '#00ff66',
              animation: (!chapter3.isDecrypted && gatewayTimer <= 3) ? 'flickerTimer 0.5s linear infinite' : 'flickerTimer 3s linear infinite',
              lineHeight: 1,
            }}>
              {!chapter3.isDecrypted ? `00:00:${gatewayTimer.toString().padStart(2, '0')}` : formatTime(timerSecs)}
            </div>
            ...
            <div style={{
              ...
              <div style={{ padding: 18 }}>
                ...
                <div style={{
                  ...
                  <span style={{ 
                    color: gatewayTimer <= 3 ? '#ff0000' : '#00ff66', 
                    fontWeight: 'bold',
                    fontSize: 14,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 12 }}>
                  <div style={{ color: '#00ff66', fontSize: 13, marginBottom: 8, letterSpacing: 1 }}>
                    [ DATA FRAGMENT RECOVERY ]<br/>
                    Convert Hex &rarr; Decimal &rarr; Word
                  </div>
              ...
              {!introRead ? (
                <>
                  ...
                  <div style={{ 
                    ...
                    background: 'linear-gradient(135deg, rgba(0,15,5,0.95) 0%, rgba(0,5,2,0.95) 100%)', 
                    padding: 24, 
                    boxShadow: '0 0 20px rgba(0,255,102,0.1), inset 0 0 30px rgba(0,255,102,0.02)' 
                  }}>
                    <div style={{ position: 'absolute', top: -1, right: -1, width: 10, height: 10, borderTop: '2px solid #00ff66', borderRight: '2px solid #00ff66' }} />
                    <div style={{ position: 'absolute', bottom: -1, right: -1, width: 10, height: 10, borderBottom: '2px solid #00ff66', borderRight: '2px solid #00ff66' }} />
                    
                    <div style={{ fontSize: 12, color: '#00ff66', marginBottom: 8, letterSpacing: 1, fontWeight: 'bold' }}>
                      TIME : 03:24 AM<br/>
                    ...
                    <div style={{ fontSize: 13, color: '#00ff41', letterSpacing: 1, lineHeight: 1.6, textShadow: '0 0 8px rgba(0,255,65,0.3)' }}>
                      While tracing the stolen credentials, investigators discover evidence of a hidden account that does not appear in any official records.<br/>
                      The account appears to have existed long before the attack began.<br/>
                      The team must uncover its purpose before the attacker erases all traces.
                    </div>
                    
                    <button onClick={() => setIntroRead(true)} style={{ ...mono, background: '#002a11', border: '1px solid #00ff66', color: '#00ff66', padding: '12px 24px', cursor: 'pointer', fontSize: 14, fontWeight: 'bold', letterSpacing: 2, transition: 'all 0.2s', marginTop: 24, width: '100%' }}
                      onMouseEnter={e => (e.currentTarget.style.background = '#00441a')}
                      onMouseLeave={e => (e.currentTarget.style.background = '#002a11')}
                    >
                      [ BEGIN TRACE ]
                    </button>
                  </div>
                </>
              ) : !chapter3.solvedQuestions.includes('q1') ? (
                <>
                  ...
                  <div style={{ 
                    ...
                    border: '1px solid rgba(0, 255, 102, 0.2)', 
                    borderLeft: '4px solid #00ff66',
                    background: 'linear-gradient(135deg, rgba(10,20,10,0.95) 0%, rgba(2,5,2,0.95) 100%)', 
                    padding: 32, 
                    boxShadow: '0 0 20px rgba(0,255,102,0.1), inset 0 0 30px rgba(0,255,102,0.02)' 
                  }}>
                    <div style={{ position: 'absolute', top: -1, right: -1, width: 10, height: 10, borderTop: '2px solid #00ff66', borderRight: '2px solid #00ff66' }} />
                    ...
                    <div style={{ color: '#00ff66', fontSize: 14, fontWeight: 'bold', letterSpacing: 2, marginBottom: 12 }}>
                ...
                <>
                  <div style={{ ...orbitron, color: '#00ffcc', fontSize: 24, letterSpacing: 4, textAlign: 'center', marginBottom: 8, textShadow: '0 0 10px #00ffcc' }}>
                    SIGNAL INTERCEPTION
                  </div>
                  {/* Q2 */}
                  <div style={{ 
                    ...
                    background: 'linear-gradient(135deg, rgba(0,10,20,0.95) 0%, rgba(0,2,5,0.95) 100%)', 
                    padding: 32, 
                    boxShadow: '0 0 20px rgba(0,255,204,0.1), inset 0 0 30px rgba(0,255,204,0.02)' 
                  }}>
                    <div style={{ position: 'absolute', top: -1, right: -1, width: 10, height: 10, borderTop: '2px solid #00ffcc', borderRight: '2px solid #00ffcc' }} />
                    <div style={{ position: 'absolute', bottom: -1, right: -1, width: 10, height: 10, borderBottom: '2px solid #00ffcc', borderRight: '2px solid #00ffcc' }} />
                    
                    <div style={{ color: '#00ffcc', fontSize: 14, fontWeight: 'bold', letterSpacing: 2, marginBottom: 12 }}>
                      [NON-TECHNICAL] MORSE CODE:
                    </div>
                    <div style={{ fontSize: 14, color: '#00e5ff', marginBottom: 16, lineHeight: 1.5 }}>
                      Decode the intercepted transmission sequence.
                    </div>
                    
                    {/* Animated Signal Receiver */}
                    <div style={{ 
                      display: 'flex', 
                      ...
                      <div style={{ position: 'absolute', left: 0, width: '100%', height: '1px', background: 'rgba(0,255,204,0.2)', top: '50%' }}></div>
                      <div style={{ 
                        display: 'flex', 
                        gap: 8, 
                        alignItems: 'center',
                      ...
                      <div style={{ position: 'absolute', left: 0, top: 0, width: '100%', height: '100%', background: 'linear-gradient(90deg, transparent 0%, rgba(0,255,204,0.1) 50%, transparent 100%)', animation: 'tickerScroll 3s linear infinite' }}></div>
                    </div>
                    ...
                    <form onSubmit={handleQ2} style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                      ...
                      <input value={q2Answer} onChange={e => setQ2Answer(e.target.value)}
                        placeholder="Enter hidden word..." style={{ ...mono, flex: 1, background: 'rgba(0,30,40,0.3)', border: '1px solid #00ffcc', padding: '8px 12px', color: '#00ffcc', outline: 'none', fontSize: 15, letterSpacing: 1 }} />
                      <button type="submit" style={{ ...mono, background: '#00222a', border: '1px solid #00ffcc', color: '#00ffcc', padding: '8px 24px', cursor: 'pointer', fontSize: 14, fontWeight: 'bold', letterSpacing: 2, transition: 'all 0.2s' }}
                        onMouseEnter={e => (e.currentTarget.style.background = '#003344')}
                        onMouseLeave={e => (e.currentTarget.style.background = '#00222a')}
                      >SUBMIT</button>
                    </form>
                  </div>
                </>
              ) : !chapter3.solvedQuestions.includes('q3') ? (
                <>
                  <div style={{ ...orbitron, color: '#00ff66', fontSize: 24, letterSpacing: 4, textAlign: 'center', marginBottom: 8, textShadow: '0 0 10px #00ff66' }}>
                    DEBUG CHALLENGE
                  </div>
                  {/* Q3 */}
                  <div style={{ 
                    ...
                    <pre style={{ ...mono, fontSize: 14, color: '#00ffcc', background: 'rgba(0,15,10,0.7)', padding: 16, borderLeft: '2px solid #00ff66', marginBottom: 24, whiteSpace: 'pre-wrap', lineHeight: 1.6 }}>
{`for(int i = 0; i < 5; i++)
{
    if(i == 3)
        break;
    ...
    System.out.print(i);
                    ...
                    <form onSubmit={handleQ3} style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                      ...
                      <input value={q3Answer} onChange={e => setQ3Answer(e.target.value)}
                        placeholder="Enter output..." style={{ ...mono, flex: 1, background: 'rgba(0,20,10,0.4)', border: '1px solid #00ff66', padding: '8px 12px', color: '#00ff66', outline: 'none', fontSize: 15, letterSpacing: 1 }} />
                      <button type="submit" style={{ ...mono, background: '#002a11', border: '1px solid #00ff66', color: '#00ff66', padding: '8px 24px', cursor: 'pointer', fontSize: 14, fontWeight: 'bold', letterSpacing: 2, transition: 'all 0.2s' }}
                        onMouseEnter={e => (e.currentTarget.style.background = '#00441a')}
                        onMouseLeave={e => (e.currentTarget.style.background = '#002a11')}
                      >SUBMIT</button>
                    </form>
              ...
              {showCompletion && (
                <div style={{ textAlign: 'center', border: '1px solid #00ff66', padding: 24, background: 'rgba(0,10,5,0.98)' }}>
                  <div style={{ ...orbitron, color: '#00ff66', fontSize: 20, letterSpacing: 4, marginBottom: 16 }}>GHOST NEUTRALIZED</div>
